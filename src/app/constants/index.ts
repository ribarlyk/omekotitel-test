export const FOOTER_COLUMNS = [
  ...
  },
  {
    ...
    links: [
      { label: "Моят акаунт", href: "/customer/account?section=dashboard", requiresAuth: true },
      { label: "История на поръчките", href: "/sales/order/history", requiresAuth: true },
...
export const NACHINI_ZA_PLASCHANE = {
  ...
  sections: [
    ...
    },
    {
      ...
      paymentMethods: ["в брой", "с карта", "наложен платеж"],
      additionalInfo: [
